...
def load_model():
    ...
    model_path="/metadata0/wxl_data/lm_sp/zh.arpa.bin"
    lm = kenlm.Model(model_path, lm_config)
    return lm
def process_line(model,line:str):
...
if __name__ == "__main__":
    ...
    for _ in range(10000):
        res=process_line(model,random_chinese)
        # print(res,random_chinese)
    end=time.time()
    print(f"res is:{res},time consume:{end-start}s")